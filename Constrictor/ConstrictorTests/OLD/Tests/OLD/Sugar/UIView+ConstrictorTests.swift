...
//        bView.constrictToParent(attributes: .top, .bottom, with: .all(Constants.constant))
//
//        // Tests
...
//        // Setup
//        viewController.view.addSubview(aView)
//        aView.constrict(attributes: .width, .height, with: .all(Constants.constant))
//
//        // Tests
