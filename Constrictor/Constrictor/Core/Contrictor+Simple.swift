...
extension Constrictor {
    ...
    public func centerY(as relation: NSLayoutConstraint.Relation = .equal,
        ...
        ConstrictorFactory.constrict(anchorA: object.centerYAnchor,
    ...
    public func top(as relation: NSLayoutConstraint.Relation = .equal,
        ...
        ConstrictorFactory.constrict(anchorA: object.topAnchor,
                                     anchorB: attribute.anchor(for: item),
                                     relation: relation,
                                     constant: constant,
                                     priority: priority,
    ...
    public func bottom(as relation: NSLayoutConstraint.Relation = .equal,
        ...
        ConstrictorFactory.constrict(anchorA: object.bottomAnchor,
                                     anchorB: attribute.anchor(for: item),
                                     relation: relation,
                                     constant: constant,
                                     priority: priority,
    ...
    public func centerX(as relation: NSLayoutConstraint.Relation = .equal,
        ...
        ConstrictorFactory.constrict(anchorA: object.centerXAnchor,
                                     anchorB: attribute.anchor(for: item),
                                     relation: relation,
                                     constant: constant,
                                     priority: priority,
    ...
    public func leading(as relation: NSLayoutConstraint.Relation = .equal,
        ...
        ConstrictorFactory.constrict(anchorA: object.leadingAnchor,
                                     anchorB: attribute.anchor(for: item),
                                     relation: relation,
                                     constant: constant,
                                     priority: priority,
    ...
    public func trailing(as relation: NSLayoutConstraint.Relation = .equal,
        ...
        ConstrictorFactory.constrict(anchorA: object.trailingAnchor,
                                     anchorB: attribute.anchor(for: item),
                                     relation: relation,
                                     constant: constant,
                                     priority: priority,
    ...
    public func right(as relation: NSLayoutConstraint.Relation = .equal,
        ...
        ConstrictorFactory.constrict(anchorA: object.rightAnchor,
                                     anchorB: attribute.anchor(for: item),
                                     relation: relation,
                                     constant: constant,
                                     priority: priority,
    ...
    public func left(as relation: NSLayoutConstraint.Relation = .equal,
        ...
        ConstrictorFactory.constrict(anchorA: object.leftAnchor,
                                     anchorB: attribute.anchor(for: item),
                                     relation: relation,
                                     constant: constant,
                                     priority: priority,
    ...
    public func width(as relation: NSLayoutConstraint.Relation = .equal,
        ...
        ConstrictorFactory.constrict(anchorA: object.widthAnchor,
                                     anchorB: attribute.anchor(for: item),
                                     relation: relation,
                                     constant: constant,
    ...
    public func width(as relation: NSLayoutConstraint.Relation = .equal,
        ...
        ConstrictorFactory.constrict(anchor: object.widthAnchor,
                                     relation: relation,
                                     constant: constant,
                                     priority: priority,
                                     isActive: isActive)
    ...
    public func height(as relation: NSLayoutConstraint.Relation = .equal,
        ...
        ConstrictorFactory.constrict(anchorA: object.heightAnchor,
                                     anchorB: attribute.anchor(for: item),
                                     relation: relation,
                                     constant: constant,
                                     multiplier: multiplier,
    ...
    public func height(as relation: NSLayoutConstraint.Relation = .equal,
        ...
        ConstrictorFactory.constrict(anchor: object.heightAnchor,
                                     relation: relation,
                                     constant: constant,
                                     priority: priority,
                                     isActive: isActive)
