...
public extension Constrictor {
    ...
    // MARK: YAxis
    @discardableResult
    func centerY(as relation: LayoutRelation = .equal,
                 to item: Anchorable,
    ...
    @discardableResult
    func top(as relation: LayoutRelation = .equal,
             to item: Anchorable,
    ...
    @discardableResult
    func bottom(as relation: LayoutRelation = .equal,
                to item: Anchorable,
    ...
    // MARK: XAxis
    @discardableResult
    func centerX(as relation: LayoutRelation = .equal,
                 to item: Anchorable,
    ...
    @discardableResult
    func leading(as relation: LayoutRelation = .equal,
                 to item: Anchorable,
    ...
    @discardableResult
    func trailing(as relation: LayoutRelation = .equal,
                  to item: Anchorable,
    ...
    @discardableResult
    func right(as relation: LayoutRelation = .equal,
               to item: Anchorable,
    ...
    @discardableResult
    func left(as relation: LayoutRelation = .equal,
              to item: Anchorable,
    ...
    @discardableResult
    func width(as relation: LayoutRelation = .equal,
               to item: Anchorable,
    ...
    @discardableResult
    func height(as relation: LayoutRelation = .equal,
                to item: Anchorable,
